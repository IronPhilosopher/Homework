...
async def get_buying_list(message):
    with open('п1.png', 'rb') as img:
        await message.answer_photo(img, f'Название: Хрома пиколинат, таблетки, 60 шт. | '
                                        f'Описание: хром играет важную роль в усвоении белков и жиров, '
                                        f'а также в профилактике сердечно-сосудистых заболеваний. | '
                                        f'Цена: 100')
    with open('п2.png', 'rb') as img:
        await message.answer_photo(img, f'Название: Магния Бисглицинат, капсулы, 60 шт. | '
                                        f'Описание: магний поддерживает здоровье костей, сердца, нервов, мышц и ЖКТ. | '
                                        f'Цена: 200')
    with open('п3.png', 'rb') as img:
        await message.answer_photo(img, f'Название: Липосомальный витамин С «PureWay»'
                                        f'с биофлавоноидами, капсулы, 60 шт. | '
                                        f'Описание: PureWay® эффективнее поддерживает иммунную систему и надпочечники,'
                                        f'по сравнению с другими формами. | '
                                        f'Цена: 300')
    with open('п4.png', 'rb') as img:
        await message.answer_photo(img, f'Название:  Липосомальный комплекс для иммунитета,'
                                        f'растительные капсулы, 60 шт. | '
                                        f'Описание: поддерживает защитные функции иммунитета против инфекций;'
                                        f'активирует барьерные функции слизистых оболочек;'
                                        f'стимулирует ускоренное выздоровление'
                                        f' после сезонных респираторных заболеваний. | '
                                        f'Цена: 400')
